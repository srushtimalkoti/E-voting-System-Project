<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_candidatewisevotes.aspx.cs" Inherits="Evoting2.reports.frm_candidatewisevotes" %>
...
<body>
 <!-- Spinner Start -->
    ...
    <h1 class='text-center mt-5 text-primary'>Candidates Wise Votes</h1>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btn_show" CssClass="btn btn-success" runat="server" onclick="btn_show_Click" Text="Show" />
