<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_voteslist.aspx.cs" Inherits="Evoting2.reports.frm_voteslist" %>
...
<body>
 <!-- Spinner Start -->
    ...
    <h1 class='text-center mt-5 text-primary'>Votes List</h1>
