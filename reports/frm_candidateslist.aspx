<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_candidateslist.aspx.cs" Inherits="Evoting2.reports.frm_candidateslist" %>
...
<body>
 <!-- Spinner Start -->
    ...
    <h1 class='text-center mt-5 text-primary'>Candidates List</h1>
