<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_candwiseresults.aspx.cs" Inherits="Evoting2.reports.frm_candwiseresults" %>
...
<body>
 <!-- Spinner Start -->
    ...
    <h1 class='text-center mt-5 text-primary'>Candidates Wise Results</h1>
    ...
    Select Candidate:
     <asp:DropDownList CssClass="form-select" ID="DropDownList1" runat="server">
        ...
        <asp:Button ID="btn_show" runat="server" CssClass="btn btn-success" onclick="btn_show_Click" Text="Show" />
        <br />
        <br />
