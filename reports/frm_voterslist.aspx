<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_voterslist.aspx.cs" Inherits="Evoting2.reports.frm_voterslist" %>
...
<body>
 <!-- Spinner Start -->
    ...
    <h1 class='text-center mt-5 text-primary'>Voters List</h1>
