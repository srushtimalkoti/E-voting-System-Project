<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Voter_Reg.aspx.cs" Inherits="Evoting2.Voter_Reg" %>
...
<body>
 <!-- Spinner Start -->
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                <a href="VoterLogin.aspx" class="nav-item nav-link active">Voter Login</a>
            </div>
            <a href="Home.aspx" class="btn btn-danger py-2 px-4 ms-3">Back to Home</a>
        </div>
    </nav>

    <h1 class='text-center mt-5 text-primary'>New Voter Registration</h1>
    ...
    <div>
        <asp:TextBox ID="txt_voter_no" required CssClass="form-control" placeholder="Enter Voter Id" runat="server"></asp:TextBox><br />
        <asp:TextBox ID="txt_name" required CssClass="form-control" placeholder="Enter your Name" runat="server"></asp:TextBox><br />
        <asp:TextBox ID="txt_email" required CssClass="form-control" 
            placeholder="Enter Email" runat="server"></asp:TextBox><br />
        <asp:TextBox ID="txt_pass" required CssClass="form-control" placeholder="Enter Password" runat="server"></asp:TextBox><br />
        <asp:Button ID="btn_reg" CssClass="btn btn-primary" runat="server" Text="Register" 
