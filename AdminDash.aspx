<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDash.aspx.cs" Inherits="Evoting2.AdminDash" %>
...
<body>
 <!-- Spinner Start -->
    ...
    <h1 class='text-center mt-5 text-primary'>Admin Dashboard</h1>
    ...
    <form id="form1" runat="server">
        ...
        <thead>
            <tr>
                <th>
                    <strong>Manage</strong></th>
                <th>
                    <strong>List Reports</strong></th>
                <th>
                    <strong>Dynamic Reports</strong></th>
            </tr>
         </thead>
         <tbody>
            <tr>
                <td>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Candidate.aspx">Candidates</asp:HyperLink>
                </td>
                <td>
                    <asp:HyperLink ID="HyperLink3" runat="server" 
                        NavigateUrl="~/reports/frm_voterslist.aspx">Voters List</asp:HyperLink>
                </td>
                <td>
                    <asp:HyperLink ID="HyperLink7" runat="server" 
                        NavigateUrl="~/reports/frm_candidatewisevotes.aspx">Candidate wise Votes</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:HyperLink ID="HyperLink2" runat="server" 
                        NavigateUrl="~/PublishResults.aspx">Publish Results</asp:HyperLink>
                </td>
                <td>
                    <asp:HyperLink ID="HyperLink4" runat="server" 
                        NavigateUrl="~/reports/frm_candidateslist.aspx">Candidates List</asp:HyperLink>
                </td>
                <td>
                    <asp:HyperLink ID="HyperLink8" runat="server" 
                        NavigateUrl="~/reports/frm_candwiseresults.aspx">Candidate wise Results</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:HyperLink ID="HyperLink5" runat="server" 
                        NavigateUrl="~/reports/frm_voteslist.aspx">Votes List</asp:HyperLink>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:HyperLink ID="HyperLink6" runat="server" 
                        NavigateUrl="~/reports/frm_resultlist.aspx">Results List</asp:HyperLink>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
