<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoterLogin.aspx.cs" Inherits="Evoting2.VoterLogin" %>
...
<body>
 <!-- Spinner Start -->
    ...
    <h1 class='text-center mt-5 text-primary'>Voter Login</h1>
    ...
    <div>
        ...
        <asp:TextBox ID="txt_voter_id" CssClass="form-control" required placeholder="Enter Voter Id" runat="server"></asp:TextBox><br />
        <asp:TextBox ID="txt_pass" CssClass="form-control" required placeholder="Enter Password" runat="server" TextMode="Password"></asp:TextBox><br />
        <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" onclick="Button1_Click" Text="Login" />
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Voter_Reg.aspx">Register Now?</asp:HyperLink><br /><br /><br />
        <p class="text-danger">Forgot Password? Contact Admin</p>
    </div>
    </form>
