<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="Evoting2.AdminLogin" %>
...
<body>
 <!-- Spinner Start -->
    ...
    <h1 class='text-center mt-5 text-primary'>Admin Login</h1>
    ...
    <div>
        ...
        <asp:TextBox CssClass="form-control" required placeholder="Enter Username" ID="txt_username" runat="server"></asp:TextBox><br />
        <asp:TextBox CssClass="form-control" required placeholder="Enter Password"  
            ID="txt_pass" runat="server" TextMode="Password"></asp:TextBox><br />
        <asp:Button ID="btn_login" CssClass="btn btn-primary" runat="server" onclick="btn_login_Click" 
            Text="Login" />
