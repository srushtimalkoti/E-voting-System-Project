<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GiveVote.aspx.cs" Inherits="Evoting2.GiveVote" %>
...
<body>
 <!-- Spinner Start -->
    ...
    <h1 class='text-center mt-5 text-primary'>Lok Sabha Election</h1>
