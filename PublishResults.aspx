<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublishResults.aspx.cs" Inherits="Evoting2.PublishResults" %>
...
<body>
 <!-- Spinner Start -->
    ...
    <h1 class='text-center mt-5 text-primary'>Publish Results</h1>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:Button CssClass="btn btn-primary" ID="btn_publish" runat="server" onclick="btn_publish_Click" 
            Text="Publish Now" />
